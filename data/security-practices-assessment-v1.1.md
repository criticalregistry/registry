...
| **libmodbus** | 1 | OSS-Fuzz enrolled; active Fuzz Introspector profile confirmed at introspector.oss-fuzz.com/project-profile?project=libmodbus (verified 2026-04-27). | High |
...
| **libpcap** | 1 | OSS-Fuzz enrolled; project directory confirmed at github.com/google/oss-fuzz/tree/master/projects/libpcap (direct URL verified 2026-04-27). | High |
| **PCRE2** | 1 | OSS-Fuzz enrolled; listed explicitly in OSS-Fuzz ideal integration documentation as a reference example. | High |
| **libssh2** | 1 | OSS-Fuzz enrolled; build.sh confirmed at github.com/google/oss-fuzz/blob/master/projects/libssh2/build.sh (direct URL verified 2026-04-27). | High |
...
- [x] **Verify medium-confidence Score 1s** (libmodbus, libpcap, libssh2) — completed 2026-04-27. All three confirmed via direct URL or Fuzz Introspector profile; confidence upgraded to High for all three.
...
| 1.1 | 2026-04-27 | Verified libmodbus (Fuzz Introspector profile), libpcap (direct project URL), libssh2 (build.sh direct URL); confidence upgraded from Medium to High for all three |
